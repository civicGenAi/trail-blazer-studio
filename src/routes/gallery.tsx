              ...
              >
                ...
                >
                  ...
                  <span className="absolute inset-x-0 bottom-0 photo-scrim p-4 opacity-0 transition-opacity duration-500 group-hover:opacity-100 group-focus-visible:opacity-100">
                    <span className="field-note block text-summit">
                      {g.place} · {g.month}
                    </span>
                    <span className="mt-1.5 block text-sm text-mist">{g.caption}</span>
                  </span>
                </button>
              </Reveal>
            ))}
      ...
      {open && (
        ...
        >
          <button
            type="button"
            onClick={() => setLightbox(null)}
            className="absolute right-4 top-4 p-2 text-mist"
            aria-label="Close"
          >
          ...
          <figure className="max-h-full w-full max-w-5xl" onClick={(e) => e.stopPropagation()}>
            ...
            <figcaption className="mt-4">
              ...
              <p className="mt-2 text-sm text-mist/85">{open.caption}</p>
              <p className="field-note mt-3 text-mist/40">
